...
function reporteIT(){
  var periodo_it = $('#periodo_it').val();
    $.ajax({
        type: "POST",
        url: base_url + 'tickets/ajax_getTicktesIT',
        data: {periodo_it : periodo_it },
        success: function(result) {
          ...
          //  alert(rs.Total);
            ...
            $('#pbCurso')[0].dataset.transitiongoal = (rs.Curso / rs.Total) * 100;
            ...
            $('#pbCancelado')[0].dataset.transitiongoal = (rs.Cancelado / rs.Total) * 100;
...
var periodo_at = $('#periodo_at').val();
  $.ajax({
      type: "POST",
      url: base_url + 'tickets/ajax_getTicktesAutos',
      data: {periodo_at : periodo_at },
      success: function(result) {
          var rs = JSON.parse(result);
...
var periodo_ed = $('#periodo_ed').val();
  $.ajax({
      type: "POST",
      url: base_url + 'tickets/ajax_getTicktesEdificio',
      data: {periodo_ed : periodo_ed },
      success: function(result) {
          var rs = JSON.parse(result);
...
var periodo_ca = $('#periodo_ca').val();
  $.ajax({
      type: "POST",
      url: base_url + 'tickets/ajax_getTicktesCafeteria',
      data: {periodo_ca : periodo_ca },
      success: function(result) {
          var rs = JSON.parse(result);
