                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <form method="POST" action=<?= base_url('tickets_IT/excel_IT') ?> class="form-horizontal form-label-left" novalidate enctype="multipart/form-data" onkeypress="return anular(event)">
                                ...
                                <select onchange="buscar_IT()" style="display: inline; width: 12%; margin-right: 10px;" required="required" class="select2_single form-control" id="opEstatus" name="opEstatus">
                                ...
                                <button onclick="buscar_IT()" style="display: inline;" class="btn btn-success" type="button"><i class="fa fa-search"></i> Buscar</button>
                            </div>
