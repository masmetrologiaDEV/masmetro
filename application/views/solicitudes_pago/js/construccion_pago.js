...
function buscar(){
    var URL = base_url + "ordenes_compra/ajax_getTempPago";
    $('#paneles').empty();
            ...
            if(result)
            {
                ...
                $.each(rs, function(i, elem){
                    ...
                    var panel = '<div class="panel">'
                        ...
                        +        '<thead>'
                        +            '<tr class="headings">'
                        +                '<th style="width: 7%" class="column-title">PO</th>'
                        +                '<th style="width: 10%" class="column-title">Proveedor</th>'
                        +                '<th style="width: 20%" class="column-title">Total</th>'
                        +            '</tr>'
                        +        '</thead>'
                        +        '<tbody>'
                        +            '<tr>'
                        +                '<td><button onclick="getPO(this)" value="' + elem.id + '" class="btn btn-default btn-md" type="button">' + elem.id + '</button></td>'
                        +                '<td>' + elem.cantidad + '</td>'
                        +                '<td>' + elem.Modelo + '</td>'
