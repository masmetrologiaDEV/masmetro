      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
               ...
               <div class="x_content">
                  <div class="row">
                     <form method="POST" action=<?= base_url('basculas/exportarAccesorios') ?> class="form-horizontal form-label-left" novalidate enctype="multipart/form-data" onkeypress="return anular(event)">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <select onchange="buscar()" style="display: inline; width: 12%; margin-right: 10px;" required="required" class="select2_single form-control" id="opTipo" name="opTipo">
                            <option></option>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalEmpresaHeader">Editar Accesorio</h4>
              </div>
              <form method="POST" action=<?= base_url('basculas/editar_accesorio') ?> class="form-horizontal form-label-left" >
              <div class="modal-body">
              ...
              <div class="item form-group" id="no_inventario">
                            ...
                            <div id="base" class="x_title"> 
                                ...
                                <div class="clearfix"></div>
                                <input name="idbase" id="idbase" type="hidden" value="">
                                <div class="item form-group" id="">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input style="text-transform: uppercase;" class="form-control col-md-7 col-xs-12" id="id_base" name="id_base" placeholder="" required="required" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group" id="">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input style="text-transform: uppercase;" class="form-control col-md-7 col-xs-12" id="serie_base" name="serie_base" placeholder="" required="required" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group" id="">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input style="text-transform: uppercase;" class="form-control col-md-7 col-xs-12" name="marca_base" id="marca_base" placeholder="" required="required" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group" id="">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input style="text-transform: uppercase;" class="form-control col-md-7 col-xs-12" id="modelo_base" name="modelo_base" placeholder="" required="required" type="text">
                                    </div>
                                </div>
                            </div>
