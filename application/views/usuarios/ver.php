              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
			     ...
			     <?php if ($this->session->privilegios['administrar_usuarios']) { ?>
                              ...
                              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12" style="margin-top: 20px;">
                                <label>Color:</label>
                                <select name="color" id="colorUsuario" class="select2_single form-control">
                                  <option value="#007bff" style="background-color: #007bff; color: #fff;">Azul</option>
                                  <option value="#6c757d" style="background-color: #6c757d; color: #fff;">Gris oscuro</option>
                                  <option value="#28a745" style="background-color: #28a745; color: #fff;">Verde</option>
                                  <option value="#dc3545" style="background-color: #dc3545; color: #fff;">Rojo</option>
                                  <option value="#ffc107" style="background-color: #ffc107; color: #000;">Amarillo</option>
                                  <option value="#17a2b8" style="background-color: #17a2b8; color: #fff;">Cian</option>
                                  <option value="#6610f2" style="background-color: #6610f2; color: #fff;">Púrpura</option>
                                  <option value="#fd7e14" style="background-color: #fd7e14; color: #fff;">Naranja</option>
                                  <option value="#20c997" style="background-color: #20c997; color: #fff;">Verde menta</option>
                                  <option value="#e83e8c" style="background-color: #e83e8c; color: #fff;">Rosa fuerte</option>
                                  <option value="#343a40" style="background-color: #343a40; color: #fff;">Negro grisáceo</option>
                                  <option value="#adb5bd" style="background-color: #adb5bd; color: #000;">Gris claro</option>
                                  <option value="#f8f9fa" style="background-color: #f8f9fa; color: #000;">Blanco humo</option>
                                  <option value="#17b978" style="background-color: #17b978; color: #fff;">Esmeralda</option>
                                  <option value="#ff5e57" style="background-color: #ff5e57; color: #fff;">Rojo coral</option>
                                  <option value="#ff9f43" style="background-color: #ff9f43; color: #000;">Naranja claro</option>
                                  <option value="#10ac84" style="background-color: #10ac84; color: #fff;">Verde océano</option>
                                  <option value="#00d2d3" style="background-color: #00d2d3; color: #000;">Turquesa</option>
                                  <option value="#8395a7" style="background-color: #8395a7; color: #fff;">Gris azulado</option>
                                  <option value="#576574" style="background-color: #576574; color: #fff;">Plomo</option>
                                </select>
                              </div>
                              <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12" style="margin-top: 20px;">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" style="margin-top: 20px;">
                                ...
                                <input accept="image/png, image/gif, image/jpeg" target="_blank" onchange="uploadFoto();" type="file" class="sr-only" id="imgAuto" name="imgAuto">
                                  <i class="fa fa-file"></i> Subir firma
                              </label>

                              <div id="simple_gallery" class="box-content">
                           <?php if (($usuario->foto_firma)) {
	
?>
                           <div class="col-md-55">
                              <div class="image view view-first">
                                 <a id="single_image" href="<?= 'data:image/png;base64,' . base64_encode($usuario->foto_firma) ?>">
                            ...
                            <form method="POST" id="frmPrivilegios" action=<?= base_url("privilegios/modificar/") ?> >
                              ...
                              <div class="col-xs-2">
                                ...
                                <ul class="nav nav-tabs tabs-left">
                                  ...
                                  <li><a href="#wo" data-toggle="tab">Ordenes de Trabajo WO</a></li>
                              ...
                              <div class="col-xs-10">
                                ...
                                <div class="tab-content">
                                  ...
                                  <div class="tab-pane" id="compras">
                                    <p class="lead">Compras</p>
                                      ...
                                      <div style="margin-top: 25px" class="row">
                                        ...
                                        <div class="col-md-4">
                                          <label style="display: block">
                                            Aprobar Compra <input name="aprobar_compra" id="aprobar_compra" onclick="notifificaciones()"  type="checkbox" class="flat" <?= $privilegio->aprobar_compra == '1' ? 'checked' : '' ?> />
                                          </label>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                          <label style="display: block">
                                            Administrador de Compras  <input name="adminCompras" type="checkbox" class="flat" <?= $privilegio->adminCompras == '1' ? 'checked' : '' ?> />
				                              ...
				                              <div style="margin-top: 25px" class="row">
                                        <div class="col-md-4" id="notificaciones_PO" style="display: none;">
                                          <label style="display: block">
                                            Recibir Notificaciones PO 
                                            <input name="recibirNotPO" type="checkbox" class="flat" <?= $privilegio->recibirNotPO == '1' ? 'checked' : '' ?> />
                                          </label>
                                        </div>                                    
                                      </div>
                                  ...
                                  <div class="tab-pane" id="wo">
                                    <p class="lead">Ordenes de Trabajo WO</p>
                                    <label>
                                      Crear WO<input type="checkbox" name="crear_wo" class="flat" <?= $privilegio->crear_wo == '1' ? 'checked' : '' ?> />
                                    </label>
                                    <label>
                                      Cerrar WO<input type="checkbox" name="cerrar_wo" class="flat" <?= $privilegio->cerrar_wo == '1' ? 'checked' : '' ?> />
                                    </label>
                                    <label>
                                      Crear Calendario<input type="checkbox" name="crear_calendario" class="flat" <?= $privilegio->crear_calendario == '1' ? 'checked' : '' ?> />
                                    </label>
                                    <label>
                                      Ver Calendario<input type="checkbox" name="ver_calendario" class="flat" <?= $privilegio->ver_calendario == '1' ? 'checked' : '' ?> />
                                    </label>
                                  </div>
...
$(document).ready(function () {
    $('#aprobar_compra').on('ifChanged', function () {
        notifificaciones();
    });
});
    const ID = '<?= $usuario->id ?>';
    ...
    ?>
function notifificaciones() {  
      var checkBox = document.getElementById("aprobar_compra");
      var text = document.getElementById("notificaciones_PO");
