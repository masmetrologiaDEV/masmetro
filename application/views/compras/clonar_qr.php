                                ...
                                <section class="content invoice">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">                                            
                                            <!-- /.col -->
                                            <input type="text" name="qr" id="qr" value="<?=$qr->id?>" hidden>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <div>
                                                <textarea id="txtComentarios" style="width:80%"><?= $qr->comentarios ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.row -->
                                    ...
                                    <div class="row no-print">
                                        <div class="col-xs-12">
                                        <button id="enviar_qr" onclick="aceptar();" class="btn btn-success pull-right"><i class="fa fa-send"></i> Enviar QR</button>
...
<!-- JS FILE -->
<script src=<?= base_url("application/views/compras2/js/clonar_qr.js"); ?>></script>
    ...
    function setValores()
    {
        ...
        $.each(cells, function(i, elem) {
            ...
            else if(campo == "descripcion")
            {
               ...
               /* var descripcion = <?= $qr->descripcion ?>;
        ...
        $('#txtRequisitosEspeciales').val('<?= $qr->especificos?>');
