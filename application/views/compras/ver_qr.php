   ...
   <div class="">
      ...
      <div class="row">
         <div class="col-md-8 col-sm-12 col-xs-12">
            <div class="x_panel" style="height: 440px; overflow-y: auto;">
               <div class="x_title">
                  <h2>QR # <?= $qr->id; ?></h2>
               ...
               <div class="x_content " >
                  <div class="row col-md-4 col-sm-6 col-xs-12" >
                     ...
                     <p class="lead">Prioridad:  <small><?= $qr->prioridad ?></small></p>
                  ...
                  <div class="row col-md-4 col-sm-4 col-xs-4" >
                     ...
                     <!--   <?php if ($this->session->privilegios['editar_qr']) { 
                        ...
                        <?php
                          ...
                          <?php 
if ($this->session->privilegios['editar_qr']) { 
    $fecha = null;

    if ($fecha_rechazo) {
        if ($fecha_rechazo->fecha instanceof DateTime) {
            $fecha = $fecha_rechazo->fecha;
        } elseif (is_string($fecha_rechazo->fecha)) {
            $fecha = new DateTime($fecha_rechazo->fecha);
        }
    }

    // Asegurarse de que $fechaReferencia sea DateTime
    $fechaReferencia = ($fecha instanceof DateTime) ? clone $fecha : new DateTime();

    $fechaActual = new DateTime();
    $diasHabiles = 0;
    $fechaIterativa = clone $fechaReferencia; // Aquí ya está validado

    while ($diasHabiles < 4) {
        $fechaIterativa->modify('+1 day');
        if ($fechaIterativa->format('N') < 6) { // Lunes a Viernes
            $diasHabiles++;
        }
    }

    if ($fechaActual < $fechaIterativa) { 
?>
        <a target="_blank" href="<?= base_url('compras/editar_qr/'.$qr->id); ?>">
            <button type="button" class="btn btn-warning btn-xs">
                <i class="fa fa-pencil"></i> Editar QR 
            </button>
        </a>
<?php 
    }
...
?>
                     ...
                     <div class="table-responsive" style="height: 265px; overflow-y: auto;">
                  ...
                  <div class="row col-md-4 col-sm-4 col-xs-4" >
                     ...
                     <center>
                        <?php if($this->session->privilegios['editar_qr']) { ?>
                        <h4><b>Estatus:</b></h4>
                        <button id="btnEstatus" onclick="mdlEstatus(this)" value="<?= $qr->estatus ?>" type="button" class="<?= 'btn ' . $btn_estatus . ' btn-lg' ?>"><?= $qr->estatus ?></button>
                        <?php } else { ?>
                        <h4><b>Estatus:</b></h4>
                        <button type="button" class="<?= 'btn ' . $btn_estatus . ' btn-lg' ?>"><?= $qr->estatus ?></button>
                        <?php } ?>
                        <h4></h4>
                        <button id="btnEstatus" onclick="bitacoraEstatus(<?= $qr->id?>)"  type="button"class="btn btn-success btn-xs">Bitacora</button>
            ...
            <div class="x_panel">
               ...
               <div class="x_content" style="height: 265px; overflow-y: auto;">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        <?php
                           ...
                           if ($this->session->departamento == 'COMPRAS') {
                               ?>
                        <button id='btnBuscarProveedor' onclick="Asignarusuario(<?=$this->session->id?>)" style="margin-left: 15px;" type="button" class="btn btn-primary btn-xs"><i class="fa fa-users"></i>  Asignarme</button>
                        <?php 
                           } ?>
            ...
            <form>
               ...
               <div style="margin-bottom: 10px;">
                  <h3 style="display: inline;">
                     Total: 
                     <h3 id="lblTotal" style="display: inline;"></h3>
                  </h3>
               </div>
                  ...
                  <div class="col-md-6">
                     <div class="row">
                        ...
                        <div class="col-md-8">
                           ...
                           <div id="dtpVencimiento" class="daterangepicker dropdown-menu ltr single opensright show-calendar picker_3 xdisplay">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-8">
                           <div id="divArchivo" style="margin-left: 8px;">
                              <a id="lnkArchivo" href="#">
                                 <img id="imgArchivo" height="25px" src="">
                                 <p style="display: inline;" id="lblArchivo"></p>
                              </a>
                           </div>
                        </div>
                     </div>
                     <br>
                     <?php 
                        if ($qr->subtipo == 'CALIBRACION' || $qr->subtipo == 'REPARACION') {
                        ?>
                     <div class="row">
                        <div class="col-md-4">
                           <div id="btnArchivoEx">
                              <label class="btn btn-default btn-sm" for="userfileEx">
                              <input accept="application/pdf" target="_blank" onchange="uploadFileEx();" type="file" class="sr-only" id="userfileEx" name="userfileEx">
                              <i class="fa fa-file"></i> Subir Ejemplo
                              </label>
                           </div>
                           <button style="display: none;" onclick="eliminarArchivoEx()" id="btnBorrarArchivoEx" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Eliminar Archivo</button>
                        </div>
                        <div class="col-md-8">
                           <div id="divArchivoEx" style="margin-left: 8px;">
                              <a id="lnkArchivoEx" href="#">
                                 <img id="imgArchivoEx" height="25px" src="">
                                 <p style="display: inline;" id="lblArchivoEx"></p>
                              </a>
                           </div>
                        </div>
                     </div>
