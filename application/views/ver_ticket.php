                ...
                <div class="x_content">
                            ...
                            <div class="block">
                                ...
                                <div class="block_content">
                                    ...
                                    <?php
                                        ...
                                        $correos =explode(',', $ticket->descripcion);
                                        foreach ($correos as $key => $value) {
                                    ?>
                                    <p class="excerpt"><?=  $value.';'?></p>
                                    <?php
                                        }
                                    ?>
                                    <br>
                    ...
                    <div class="btn-group">
                        ...
                        <ul role="menu" class="dropdown-menu">
                            <?php
                            if ($ticket->Cierre == "0" && $this->session->privilegios[strtolower($controlador) . '_soporte'] || $this->session->id == 13) {
                                ...
                                switch ($ticket->estatus) {
                                    ...
                                    case 'EN CURSO':
                                        echo "<li><a href='" . base_url() . $controlador . "/estatus/" . $ticket->id . "/3'>Detenido</a></li>";
                                        echo "<li><a href='" . base_url() . $controlador . "/estatus/" . $ticket->id . "/7'>En Revision</a></li>";
                                        echo "<li class='divider'></li>";
                                        echo "<li><a href='" . base_url() . $controlador . "/estatus/" . $ticket->id . "/5'>Solucionado</a></li>";
                                        break;
                                    case 'EN REVISION':
                            ...
                            if (($ticket->usuario == $this->session->id) || $this->session->id == 13) {
                                if ($ticket->estatus != "CANCELADO" && $ticket->estatus != "CERRADO" && $ticket->estatus == "SOLUCIONADO") {
                                    echo "<li class='divider'></li>";
                                    if ($ticket->Cierre == "0") {
                                        echo "<li><a href='" . base_url() . $controlador . "/estatus/" . $ticket->id . "/4'>Cancelado</a></li>";
                                    }
                            ...
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" id="frmComentarios" action=<?= base_url($controlador . '/agregarComentario') ?>>
