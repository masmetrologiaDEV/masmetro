                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-building-o"></i> Empresas<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                        ...
                                        <?php } ?>
                                        <li><a href=<?= base_url("empresas/paises"); ?>>Catalogo de Paises</a></li>
                                      </ul>
                                    </li>

                                    <li><a><i class="fa fa-money"></i> Finanzas<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                            <li><a href=<?= base_url("finanzas"); ?>>REMPSE</a></li>
                                      </ul>
                                    </li>
                                    <li><a><i class="fa fa-check"></i> Calidad<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                            <li><a href=<?= base_url("calidad"); ?>>Calidad</a></li>
                                            <li><a href=<?= base_url("calidad/reportes"); ?>>Reportes</a></li>
                                      </ul>
                                    </li>
                                    ...
                                    <li><a><i class="fa fa-cutlery"></i> Cafeteria<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href=<?= base_url("cafeteria/"); ?>><i class='fa fa-coffee'></i> Cafeteria</a></li>
                                            <li><a href=<?= base_url("cafeteria/mis_tickets/"); ?>><i class='fa fa-coffee'></i> Mis Comentarios</a></li>
                                            <?php if ($this->session->privilegios['cafeteria']) { ?>
                                            <li><a href=<?= base_url("cafeteria/tickets/"); ?>><i class='fa fa-coffee'></i> Comentarios</a></li>
                                            <?php } ?> 
                                        </ul>
                                    </li>
                                    ...
                                    <li><a><i class="fa fa-shopping-cart"></i> Compras<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                        ...
                                        <?php } ?>
                                            ...
                                            <li><a href=<?= base_url("ordenes_compra/generar_pago"); ?>>Solicitud de Pago</a></li>
                                        
                                      </ul>
                                    </li>

                                    <li><a><i class="fa fa-shopping-cart"></i> Solicitudes de Pago<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                            <li><a href=<?= base_url("solicitudes_pago/generar_pago"); ?>>Solicitud de Pago</a></li>
                                            <li><a href=<?= base_url("solicitudes_pago/catalogo_solicitudes"); ?>>Catalogo Solicitud de Pago</a></li>
                                      </ul>
                                    </li>
                                    ...
                                    <li><a><i class="fa fa-wrench"></i> Proyectos<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href=<?= base_url("proyectos/"); ?>> Nuevo Proyecto</a></li>
                                        </ul>
                                    </li>
                                  ...
                                  <!--  <li><a><i class="fa fa-desktop"></i> Monitor de Compras<span class="fa fa-chevron-down"></span></a>
                                    ...
                                    <?php if ($this->session->privilegios['crear_wo'] || $this->session->privilegios['cerrar_wo']) { ?>
                                        <li><a><i class="fa fa-briefcase"></i> Ordenes de Trabajo<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href=<?= base_url("ordenes_trabajo/"); ?>>Mis WO</a></li>
                                    <?php if ($this->session->privilegios['cerrar_wo']) { ?>
                                            <li><a href=<?= base_url("ordenes_trabajo/catalogo_wo"); ?>>Ordenes de Trabajo</a></li>
                                            <?php } ?>
                                            <li><a href=<?= base_url("ordenes_trabajo/calendario"); ?>>Calendario</a></li>
                                        </ul>
                                        </li>
                                    <?php } ?>
                                    ...
                                    <li><a><i class="fa fa-truck"></i> Logística<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href=<?= base_url("logistica/lotes"); ?>>Crear Lote</a></li>
                                    ...
                                    <li><a><i class="fa fa-ticket"></i> Tickets de Servicio<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href=<?= base_url("cafeteria/mis_tickets"); ?>>Mis Comentarios Cafeteria</a></li>
                                            <?php
                                            if ($this->session->privilegios['tickets_it_soporte'] ) {
                                            ?>
                                            <li><a href=<?= base_url("tickets/camaras"); ?>>Camaras de Seguridad</a></li>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <li><a><i class="fa fa-automobile"></i> Autos<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                           <li><a href=<?= base_url("autos/alta_autos"); ?>>Alta de Autos</a></li>
                                          ...
                                          <li><a href=<?= base_url("autos/uso_autos"); ?>>Uso de Automóviles</a></li>
                                          <li><a href=<?= base_url("autos/gps"); ?>>GPS</a></li>
                                      </ul>
                                    </li>

                                    <li><a><i class="fa fa-balance-scale"></i> Basculas<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                        <li><a href=<?= base_url("basculas/alta_equipos"); ?>>Alta de Equipos</a></li>
                                        <li><a href=<?= base_url("basculas/"); ?>>Catalogo Basculas</a></li>
                                        <li><a href=<?= base_url("basculas/accesorios"); ?>>Catalogo Accesorios</a></li>
                                        <li><a href=<?= base_url("basculas/lotes"); ?>>Lotes</a></li>
                                      </ul>
                                    </li>
                                    ...
                                    <?php if ($this->session->privilegios['administrar_equipos_it'] == "1") { ?>
                                        <li><a><i class="fa fa-hdd-o"></i> Equipos<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu">
                                                <li><a href=<?= base_url("equipos/generador"); ?>><i class="fa fa-plug"></i>Generador</a></li>
                                                <li><a href=<?= base_url("equipos/dashboard"); ?>><i class="fa fa-keyboard-o"></i>Dashboard</a></li>
                                                ...
                                                <li><a href=<?= base_url("equipos/catalogo_mantenimiento"); ?>><i class="fa fa-keyboard-o"></i>Catalogo 
                                                Mantenimiento</a></li>
                                            </ul>
                                        </li>
                                    <?php } ?>
                                    ...
                                    <li><a><i class="fa fa-clock-o"></i> Reloj Checador<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                        <li><a href=<?= base_url('reloj_checador'); ?>>Checador</a></li>
                                    ...
                                    <li><a><i class="fa fa-cogs"></i> Configuración<span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                        ...
                                        <li><a href=<?= base_url("configuracion/notificaiones"); ?>>Notificaiones</a></li>
                                      </ul>
                                    </li>
...
open('/chat/index.php','popup','top=150,left=100,width=450,height=600');
