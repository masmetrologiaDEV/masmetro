                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <p class="lead" style="display: inline;">Requisitor: <small id='lblReq'></small></p><br> <br> 
                ...
                <div class="x_panel">
                    <div class="x_content">
                        <div class="table-responsive">
                            ...
                            <div id='divRecibida' style='display: ;'>
                                <?php if($this->session->privilegios['editar_qr'] == "1" | $this->session->privilegios['liberar_qr'] == "1") { ?>
                                    <button onclick='setEstatus(this)' value='CANCELADA' class='btn btn-default btn-md' type='button'><i class='fa fa-close'></i> Cancelar</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="btnRecibir" onclick="recibir()"  type="button" class="btn btn-primary"><i class="fa fa-check"></i> Recibir</button>
            </div>
...
<div id="mdlAccion" class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" style="display: inline;" type="button" class="btn btn-default pull-left"><i class="fa fa-close"></i> Cancelar</button>
                <button id="btnSeguimiento" onclick="crearAccion()" style="display: inline;" type="button" class="btn btn-primary"><i class="fa fa-bolt"></i> Crear Seguimiento</button>
            </div>
