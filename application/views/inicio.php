                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    foreach ($cafeteria->result() as $dato){
                                        ...
                                        ?>
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <td><?= $dato->tipo; ?></td>
                                                <td><?= $dato->titulo; ?></td>
                                                <td><button class="btn btn-primary btn-xs"><?= $dato->estatus ?></button></td>
                                                <td><a href="<?= base_url('cafeteria/ver/' . $dato->id) ?>" class="btn btn-success btn-xs">Ver comentario</a></td>
