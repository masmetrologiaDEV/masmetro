                                        ...
                                        <div class="col-xs-12 table">
                                            <table>
                                                <thead>
                                                    ...
                                                    <th id="tIntervalo" style="width:30%;">Intervalo de calibración</th>  
                                                </thead>
                                            <tbody>
                                                <td>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form method="POST" action=<?= base_url('compras/agregarComentario') ?> id="frmComentarios">
                ...
                <div class="modal-footer">
                <center>
                    <input id="btnAgregarComentario" onclick="modificar()" type="" class="btn btn-primary" value="Agregar">
                </center>
                </div>
            </form>
...
<script>
    ...
    function setValores()
    {
        ...
        //$('#tipoCalibracion').val('<?= $qr->tipoCalibracion?>');
    ...
    function modificar(){
        ...
        $.each(cells, function(i, elem) {
            ...
            if(document.getElementById("txtRequisitosEspeciales").value == '')
            {
                alert("Capture Requisitos Especificos")
                exit();
            }
            else if(campo == "descripcion")
            {
