...
function editarQR(info, atributos){
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            {
                new PNotify({ title: 'ERROR', text: 'Error al editar QR', type: 'error', styling: 'bootstrap3' });
            }
          },
        error: function(data){
            new PNotify({ title: 'ERROR', text: 'Error al editar1 QR', type: 'error', styling: 'bootstrap3' });
            console.log(data);
        },
      });
}
