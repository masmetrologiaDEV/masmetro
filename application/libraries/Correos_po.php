...
//echo var_dump($correos);die();
    ...
    function aprobarPO($PO) {
        ...
        $mensaje = "
            <img width='400' src='$logo'><br>
            <h1><font face='Times'>SIGA-MAS</font></h1>
            <h2><font color='green'>Se ha autorizado PO (Orden de Compra)</font></h2>
            <p><b>ID:</b> $idCompleto</p>
    ...
    function ordenarPO($PO) {
        ...
        $mensaje = "
            <img width='400' src='$logo'><br>
            <h1><font face='Times'>SIGA-MAS</font></h1>
            <h2><font color='green'>Se ha ordenado PO (Orden de Compra)</font></h2>
            <p><b>ID:</b> $idCompleto</p>
            <p><b>Comprador:</b> $comprador</p>
            <p><b>Prioridad:</b> $prioridad</p>
            <p><b>Proveedor:</b> $proveedor</p>
            ...
            <p><b>Total:</b> $total</p>
            <br>
            <p><b>Ordenada por:</b> $aprobador</p>
            <a href='$url' class='btn btn-primary'>Ver PO</a>";
     ...
     function recibirPO($PO) {
        $CI = & get_instance();
        $CI->load->library('email');

        $id = $PO->id;
        $fecha = date('d/m/Y h:i A');
        $recibidor=$PO->recibidor;
        ...
        $mensaje = "
            <img width='400' src='$logo'><br>
            <h1><font face='Times'>SIGA-MAS</font></h1>
            <h2><font color='orange'>Se ha recibido PO (Orden de Compra)</font></h2>
            <p><b>ID:</b> $idCompleto</p>
            <br>
            <p><b>Recibida por: </b> $recibidor</p>
    ...
    function cancelarPO($PO) {
        ...
        $mensaje = "
            <img width='400' src='$logo'><br>
            <h1><font face='Times'>SIGA-MAS</font></h1>
            <h2><font color='red'>Se ha cancelado PO (Orden de Compra)</font></h2>
            <p><b>ID:</b> $idCompleto</p>
            <p><b>Comprador:</b> $comprador</p>
            <p><b>Prioridad:</b> $prioridad</p>
            <p><b>Proveedor:</b> $proveedor</p>
            ...
            <p><b>Total:</b> $total</p>
            <br>
            <p><b>Cancelado por:</b> $aprobador</p>
            <a href='$url' class='btn btn-primary'>Ver PO</a>";
    ...
    function cerrarPO($PO) {
        ...
        $mensaje = "
            <img width='400' src='$logo'><br>
            <h1><font face='Times'>SIGA-MAS</font></h1>
            <h2><font color='blue'>Se ha cerrado PO (Orden de Compra)</font></h2>
            <p><b>ID:</b> $idCompleto</p>
            <p><b>Comprador:</b> $comprador</p>
            <p><b>Prioridad:</b> $prioridad</p>
            <p><b>Proveedor:</b> $proveedor</p>
