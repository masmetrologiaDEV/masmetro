...
EOD;
    ...
    function comentarioQR($datos) {
        ...
        $mensaje = <<<EOD
               ...
               <br>
               <p><b>Comentario de $usuario: </b> $comentario</p>
               <a href='$url' class='btn btn-primary'>Ver QR</a>
EOD;
...
//echo var_dump($correo_us);die();
      ...
      $mensaje = <<<EOD
             ...
             <h1><font face="Arial">SIGA-MAS</font></h1>
             <h2>Work Orders</h2>
             <h3>El usuario: $usuario ha     WO#: $mail</h3>
             Estimado cliente,
             Conforme a su requerimiento, le hacemos de su conocimiento que hemos finiquitado el servicio solicitado satisfactoriamente.
...
$CI->email->attach($foto);
 ...
 function crear_wo($datos){
      ...
      $mensaje = <<<EOD
             ...
             <h1><font face="Arial">SIGA-MAS</font></h1>
             <h2>Work Orders</h2>
             <h3>El usuario: $usuario ha creado WO#: $mail</h3>
             <a href='$url' class='btn btn-primary'>Ver WO</a>                   
...
EOD;
    ...
    function registrar_tool($datos){
      ...
      $url = base_url('toolcrib/aprobarPedido/'.$tool);
      ...
      $mensaje = <<<EOD
             ...
             <h1><font face="Arial">SIGA-MAS</font></h1>
             <h2>Work Orders</h2>
             <h3>El usuario: $usuario ha creado un pedido en Tool Crib #: $tool</h3>
