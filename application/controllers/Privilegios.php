...
class Privilegios extends CI_Controller {
	...
	if (filter_var($this->input->post('autorizarTC'), FILTER_VALIDATE_BOOLEAN) ==true) {
        ...
        $datos = array(
            ...
            'crear_calendario'=>filter_var($this->input->post('crear_calendario'), FILTER_VALIDATE_BOOLEAN),
            'ver_calendario'=>filter_var($this->input->post('ver_calendario'), FILTER_VALIDATE_BOOLEAN),
